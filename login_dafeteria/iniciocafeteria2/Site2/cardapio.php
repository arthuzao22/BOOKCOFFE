            ...
            <div class="col-lg- offset-">
                ...
                <table class="table table-dark table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="cadapd.php" method="get">
                                <input name="qtde" id="botaoc" type="number">
                                <button type="submit" id="botaoc">Selecionar</button>
                                <input type="hidden" value="<?php echo $row['cod_produto'] ?>" name="id_produto">
                                <input type="hidden" value="<?php echo $_GET['cod_pedido'] ?>" name="id_pedido">
                            </form>
                        </td>
