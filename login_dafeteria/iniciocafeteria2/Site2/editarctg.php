...
<body data-home-page="Sobre.html" data-home-page-title="Sobre" class="u-body u-xl-mode" data-lang="pt" style="background-color: black;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 offset-4">
                <h4 style="color: white;">Alterar categoria</h4>                
                <form action="editar_categoria.php" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" style="background-color: #323736;color: white" class="form-control" id="descricao_categoria" name="descricao_categoria">
                    </div>
    ...
    <footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-8c71" style="margin-top: 30vmax;">
        <div class="u-clearfix u-sheet u-sheet-1">
            <p class="u-small-text u-text u-text-variant u-text-1">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Repellendus impedit quos culpa perspiciatis enim doloremque ex laudantium, alias reiciendis, ab id sit pariatur voluptatum? Consectetur suscipit quaerat officia explicabo facilis.</p>
        </div>
    </footer>
