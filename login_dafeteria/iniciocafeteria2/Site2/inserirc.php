...
<body data-home-page="Sobre.html" data-home-page-title="Sobre" class="u-body u-xl-mode" data-lang="pt"
    ...
    <div class="container">
        <div class="row">
            ...
            <div id="cf" class="col">
                <h1 style="color:white; text-align: center; font-family: 'Nanum Myeongjo', serif;">LOGIN CLIENTES</h1>


                <form action="inserir_cliente.php" method="post">
                    <div class="mb-3">

                        <input type="hidden" value="<?php echo $_GET['id'] ?>" name="mesas">
                        ...
                        <label for="ceclular_cliente" class="form-label">
                            <h5>Celular</h5>
                        </label>
                        <input type="text" style="background-color: #323736;color: white" class="form-control"
                    ...
                    <input type="submit" id="botaoc" class="btn btn-outline-primary" value="Inserir">
